...
public interface UserDao {
    ...
    @Update({"update wx_user set nickname = #{nickname},gender = #{gender},city = #{city},province = #{province},country = #{country},avatarurl = #{avatarurl},language = #{language},timestamp = #{timestamp},trancheckstatus=#{trancheckstatus},roleid=#{roleid} where openid = #{openid}"})
